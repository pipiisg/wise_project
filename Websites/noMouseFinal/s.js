...
function mainMenu()
{
    ...
    c.stroke();
    c.font = "40px Tahoma";
    let bottomOfText1 = wrapText("NEW CONTROLS", boxLeft + 30, boxTop + 50, boxRight - boxLeft - 60, 40);
    c.beginPath();
    c.moveTo(boxLeft + 5, bottomOfText1 - 20);
    c.lineTo(boxRight - 5, bottomOfText1 - 20);
    c.stroke();
    c.font = "30px Tahoma";
    bottomOfText1 = wrapText("WASD to move", boxLeft + 30, bottomOfText1 + 20, boxRight - boxLeft - 60, 40);
    bottomOfText1 = wrapText("Press p to cast a damage spell.", boxLeft + 30, bottomOfText1 + 20, boxRight - boxLeft - 60, 40);
    bottomOfText1 = wrapText("Press o to cast a push spell.", boxLeft + 30, bottomOfText1 + 20, boxRight - boxLeft - 60, 40);
    bottomOfText1 = wrapText("Press i to double jump.", boxLeft + 30, bottomOfText1 + 20, boxRight - boxLeft - 60, 40);
    return 0;
}
function aboutMenu()
{
    ...
    const textAbout = "NeuraI stands for \"NeuraI excessively uses real artificial intelligence\". In the full version, AI is used to figure out what shape you draw " + 
    ...
    while (true)
    {
        ...
        switch (currentDisplay){
            ...
            case 3:
                ...
                {
                    mainBotsLoaded = true;
                    [mainBotMove, mainBotSpell] = await loadBotModels("../finalGame/botMove61.324/model.json", "../finalGame/botSpell61.324/model.json");
                }
            ...
            case 4:
                ...
                if (!imitatorBotsLoaded)
                {
                    ...
                    [imitatorMove, imitatorSpell] = await loadBotModels("../finalGame/botMove61.324/model.json", "../finalGame/botSpell61.324/model.json");
                }
